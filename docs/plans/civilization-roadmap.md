...
- Contract types: escort, defense, supply, research
...
1. Bonds and pair/party formation
2. Clan hunting with follow/protect
3. Settlement detection and communal storage
4. Basic trading and local price averaging
5. Teaching action with guild seeding
